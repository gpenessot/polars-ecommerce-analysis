...
results_dir = "/home/gael/Documents/Github/polars-ecommerce-analysis/data/processed/report_20250119_002139/results"
...
segment_value = (customer_metrics
    .groupby('RFM_Segment')
    .agg({'MonetaryValue': 'mean'})
    .sort('MonetaryValue', ascending=False))
